...
import { startRoombaCleaning, stopRoombaCleaning } from "@/api/api.roomba";
    ...
    <Card className="p-5 shadow-lg border rounded-lg transition-transform transform hover:scale-[1.02]">
      ...
      <CardContent className="space-y-3 mt-4">
        ...
        <div className="space-y-1">
          <p
            className="flex items-center gap-3 text-blue-500 hover:underline cursor-pointer transition"
